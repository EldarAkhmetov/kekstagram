...
(function() {
  ...
  var changeScalePinX = function(shift) {
  ...
  var changePinValue = function(shift) {
    var newScalePinX = changeScalePinX(shift);
    var offsetPercent = Math.round(newScalePinX / SCALE_MAX * MAX_PERCENT);
    scalePin.style.left = newScalePinX + 'px';
    scaleLevel.style.width = offsetPercent + '%';
    scaleValue.value = offsetPercent;
